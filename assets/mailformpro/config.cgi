...
## フォームの宛先
push @mailto,'info@nono-hana.co.jp';
...
$config{'ThanksPage'} = 'https://nono-hana.co.jp/contact/thanks.php?no=%s';

## 設置者に届くメールの件名
$config{'subject'} = '[ %s ] HPからのお問い合わせ';
...
この度は、訪問看護ステーション野の花にお問い合わせいただき誠にありがとうございます。
...
お電話（ 06-4393-8474 ）にてご連絡いただけますと幸いです。
...
[住所]
〒557-0001
大阪府大阪市西成区山王三丁目14番10号 リバープラザ山王106号
[電話番号]
06-4393-8474(24時間対応)
[URL]
https://nono-hana.co.jp/
