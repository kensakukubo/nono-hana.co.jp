      ...
      <div class="page-content">
        ...
        <section class="guide-section" id="support">
          ...
          <ul class="guide-support-grid" role="list">
            ...
            <li class="guide-support-tile">
              <div class="guide-support-tile__icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M12 22c4.97 0 9-4.03 9-9-4.97 0-9 4.03-9 9zM5.6 10.25c0 1.19.27 2.32.74 3.32l-2.17 2.17C3.15 13.68 2 11.47 2 9c0-3.86 3.14-7 7-7h2v9H5.6z"/></svg>
              </div>
              <span class="guide-support-tile__tag">補助</span>
              <p class="guide-support-tile__text">庭仕事の手伝い</p>
            </li>
            <li class="guide-support-tile">
              <div class="guide-support-tile__icon" aria-hidden="true">
