 ...
 *
 * 固定ページのスラッグを thanks に（/thanks/）。タイトル例: お問い合わせを受け付けました
 */
?>
<?php get_header(); ?>
<?php
...
<main class="l-page l-page--thanks">
	...
	<div class="w-inner">
		<article <?php post_class(); ?>>
			<div class="page-content page-content--thanks">
				<section class="guide-section thanks-section">
					<div class="thanks-card">
						<div class="thanks-card__inner">
							...
							<p class="thanks-card__text">
								お急ぎのご用件は、お電話または LINE からも承っております。
							</p>
							<p class="thanks-card__tel-line">
								代表 <a href="tel:<?php echo esc_attr( grouphome_phone_main_tel_digits() ); ?>" class="thanks-card__tel-link"><?php echo esc_html( grouphome_phone_main_display() ); ?></a>
								<span class="thanks-card__tel-sep">／</span>
								緊急 <a href="tel:<?php echo esc_attr( grouphome_phone_emergency_tel_digits() ); ?>" class="thanks-card__tel-link thanks-card__tel-link--sub"><?php echo esc_html( grouphome_phone_emergency_display() ); ?></a>
							</p>
